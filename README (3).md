...
El proyecto incluye un archivo `.env.example` en FrontEnd.  
Los datos de ese archivo deben ser reemplazados por el `.env` real para su funcionamiento.  
...
El archivo `skillmatch_uba.sql` contiene el esquema y los datos iniciales necesarios para probar la aplicación.
